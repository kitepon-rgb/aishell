...
const ref = "agents.followup_task:/root/ace034_impact_continuation_writer#ace034-impact-continuation-retry2-run";
const observed_at = "2026-07-22T06:17:00.000Z";
const result = await observeWorker({
  ...
  expected_revision: 121,
  worker_run_id: "ace034-impact-continuation-retry2-run",
  observation: {
    state: "dispatched", source: "codex-native", observed_version: "gpt-5.6-terra",
    observed_at, raw_state: "native implementer follow-up dispatched after clean reservation",
