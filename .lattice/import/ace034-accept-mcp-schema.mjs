...
const worker_run_id = "ace034-mcp-schema-writer-run";
...
const verification = "親再検証: MCPRunCheckV2SchemaTests 11/11、MCPTypesTests 7/7、git diff --check成功";
const evidence = {
  type: "command",
  ref: "parent-focused-verification:ace034-mcp-schema",
  digest: createHash("sha256").update(verification).digest("hex"),
  observed_at: "2026-07-22T05:39:06.000Z",
};
result = await accept({
  cwd,
  control_id,
