...
- [AIShellをCodexの別タスクへ公開する](codex-mcp-registration.md) — npm版stdio MCP登録、expanded-v1 11 tool、typed startup failure、Git worktree実効root、lane分離、0.4.8〜0.4.11のClaude互換・検索既定／性能／file scope実測（2026-08-04、確度: 高）
