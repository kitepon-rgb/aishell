...
- [AIShellをCodexの別タスクへ公開する](codex-mcp-registration.md) — npm版stdio MCP登録、default 7/full 25とexpanded-v1 development 11/full 29、typed startup failure、Git worktree実効root自動反映、0.3.5/0.3.6の結果状態実測（2026-07-24、確度: 高）
